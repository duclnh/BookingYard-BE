...
{
	public class GetVnpayReturnQueryHandler : IRequestHandler<GetVnpayReturnQuery, string>
	{
		...
		public async Task<string> Handle(GetVnpayReturnQuery request, CancellationToken cancellationToken)
		{
