...
{
	public record GetAllBookingCustomerQuery(RequestParams requestParams, Guid userId, CancellationToken cancellation) : IRequest<PagingResult<BookingDetailDto>>
	{
	}
}
